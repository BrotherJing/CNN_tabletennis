...
#MODEL_DIR=/home/jing/Downloads/py-faster-rcnn/data/faster_rcnn_models/ZF_faster_rcnn_final.caffemodel
CAFFE_ROOT=/home/jing/caffe/build_cmake

$CAFFE_ROOT/tools/caffe train --solver=models/end2end_solver.prototxt --weights=$MODEL_DIR --gpu=0